#include "src/components/lib/qtmaterialstyle.h"
...
QtMaterialStylePrivate::QtMaterialStylePrivate(QtMaterialStyle *q) : q_ptr(q) {}
...
QtMaterialStyle::QtMaterialStyle()
    : QCommonStyle(), d_ptr(new QtMaterialStylePrivate(this)) {
  d_func()->init();
}
