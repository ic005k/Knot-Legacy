#include "src/components/lib/qtmaterialrippleoverlay.h"

#include <QPainter>

#include "src/components/lib/qtmaterialripple.h"
...
QtMaterialRippleOverlay::QtMaterialRippleOverlay(QWidget *parent)
    : QtMaterialOverlayWidget(parent), m_useClip(false) {
...
void QtMaterialRippleOverlay::paintRipple(QPainter *painter,
