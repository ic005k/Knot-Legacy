...
function setViewerModes(scroll, spread) {
    console.log("===pdf.viewer.bridgp.js: setViewerModes...")
    PDFViewerApplication.pdfViewer.scrollMode = scroll

    //PDFViewerApplication.toolbar.setViewerModes(scroll, spread)
}
